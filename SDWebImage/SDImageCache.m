...
- (id)initWithNamespace:(NSString *)ns
{
    if ((self = [super init]))
    {
        ...
        _memCache.totalCostLimit = (10000 + 14400) / 2 * 50; // avatar costs 10000, thumbnail costs 14400
...
- (NSString *)cachedFileNameForKey:(NSString *)key
{
    ...
    NSString *filename = [NSString stringWithFormat:@"%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x.%@",
                          r[0], r[1], r[2], r[3], r[4], r[5], r[6], r[7], r[8], r[9], r[10], r[11], r[12], r[13], r[14], r[15], ext];
...
- (void)setAllowsMemoryCache:(BOOL)allowsMemoryCache
{
    _allowsMemoryCache = allowsMemoryCache;
}
...
- (UIImage *)imageFromDiskCacheForKey:(NSString *)key
{
    ...
    if (diskImage && self.allowsMemoryCache)
    {
